...
const fallbackEnterpriseSettings = {
  authentication: {
    ...
    allowedDomains: ["northstar.example", "northstarops.com"],
    defaultIdentityProviderId: "idp-google-demo",
  },
  identityProviders: [
    {
      id: "idp-google-demo",
      ...
      clientId: "google-demo-client",
      authority: "https://accounts.google.com",
      metadataUrl: "https://accounts.google.com/.well-known/openid-configuration",
      tenantIdentifier: "my_customer",
      scopes: ["openid", "email", "profile"],
      domainHints: ["northstarops.com"],
      provisioningMode: "JustInTime",
      isEnabled: true,
      isPrimary: true,
      validationStatus: "Valid",
      lastValidationError: "",
      lastValidatedAtUtc: new Date("2026-04-01T14:15:00Z").toISOString(),
      lastSyncAtUtc: new Date("2026-04-01T15:05:00Z").toISOString(),
    },
    {
      id: "idp-microsoft-demo",
      organizationId: fallbackOrganization.id,
      name: "Northstar Entra ID",
      providerType: "MicrosoftEntraId",
      clientId: "microsoft-demo-client",
      authority: "https://login.microsoftonline.com/common/v2.0",
      metadataUrl: "https://login.microsoftonline.com/common/v2.0/.well-known/openid-configuration",
      tenantIdentifier: "contoso-tenant-id",
      scopes: ["openid", "profile", "email"],
      domainHints: ["northstar.example"],
      provisioningMode: "Manual",
      isEnabled: true,
      isPrimary: false,
      validationStatus: "Valid",
      lastValidationError: "",
      lastValidatedAtUtc: new Date("2026-04-01T14:45:00Z").toISOString(),
      lastSyncAtUtc: new Date("2026-04-01T14:45:00Z").toISOString(),
    },
  ],
  integrations: [
    {
      id: "integration-google-demo",
      organizationId: fallbackOrganization.id,
      ...
      lastValidatedAtUtc: new Date("2026-04-01T14:30:00Z").toISOString(),
      lastSyncAtUtc: new Date("2026-04-01T15:05:00Z").toISOString(),
      lastError: "",
    },
    {
      id: "integration-microsoft-demo",
      organizationId: fallbackOrganization.id,
      ...
      lastValidatedAtUtc: new Date("2026-04-01T14:10:00Z").toISOString(),
      lastSyncAtUtc: new Date("2026-04-01T14:50:00Z").toISOString(),
      lastError: "",
    },
  ],
  verifiedDomains: [
    {
      id: "domain-northstarops",
      organizationId: fallbackOrganization.id,
      domain: "northstarops.com",
      verificationMethod: "DnsTxt",
      status: "Verified",
      challengeToken: "flowforge-verification=northstarops",
      verifiedAtUtc: new Date("2026-03-29T12:00:00Z").toISOString(),
      lastCheckedAtUtc: new Date("2026-04-01T13:30:00Z").toISOString(),
      failureReason: "",
    },
  ],
  provisioning: {
    ...
    organizationId: fallbackOrganization.id,
    syncMode: "JustInTime",
    identityProviderId: "idp-google-demo",
    autoProvisionNewUsers: true,
    autoDeactivateMissingUsers: false,
    groupMappingStrategy: "IdpGroup",
    scimBaseUrl: "",
    lastSyncAtUtc: new Date("2026-04-01T14:20:00Z").toISOString(),
    lastSyncStatus: "Succeeded",
    lastSyncError: "",
  },
  provisioningJobs: [
    {
      id: "provisioning-job-demo",
      organizationId: fallbackOrganization.id,
      identityProviderId: "idp-google-demo",
      syncMode: "JustInTime",
      status: "Succeeded",
      triggeredBy: "OrgAdmin",
      summary: "Workspace team membership sync completed.",
      usersProcessed: 18,
      usersCreated: 2,
      usersUpdated: 9,
      usersDeactivated: 0,
      errorDetails: "",
      startedAtUtc: new Date("2026-04-01T14:18:00Z").toISOString(),
      completedAtUtc: new Date("2026-04-01T14:20:00Z").toISOString(),
    },
  ],
  directoryGroupMappings: [
    {
      ...
      organizationId: fallbackOrganization.id,
      identityProviderId: "idp-google-demo",
      teamId: fallbackTeams[0].id,
      externalGroupId: "delivery-managers",
      externalGroupName: "Delivery Managers",
      defaultRole: "Manager",
      isActive: true,
      syncMembers: true,
      lastSyncedAtUtc: new Date("2026-04-01T14:20:00Z").toISOString(),
      lastSyncError: "",
    },
  ],
  notificationRoutes: [
    {
      id: "notification-route-demo",
      organizationId: fallbackOrganization.id,
      integrationConnectionId: "integration-microsoft-demo",
      notificationType: "Assignment",
      targetType: "TeamsChannel",
      destinationReference: "19:leadership@thread.tacv2",
      destinationLabel: "Leadership Operations",
      isActive: true,
      sendDailyDigest: true,
      lastDeliveredAtUtc: new Date("2026-04-01T15:10:00Z").toISOString(),
      lastDeliveryError: "",
    },
  ],
  exportDestinations: [
    {
      id: "export-destination-demo",
      organizationId: fallbackOrganization.id,
      integrationConnectionId: "integration-google-demo",
      destinationType: "GoogleDriveFolder",
      name: "Executive Reports",
      destinationReference: "drive-folder-id",
      destinationPath: "/Shared drives/Executive Reports",
      isDefault: true,
      isActive: true,
      lastValidatedAtUtc: new Date("2026-04-01T13:45:00Z").toISOString(),
      lastValidationError: "",
      lastDeliveredAtUtc: new Date("2026-04-01T15:00:00Z").toISOString(),
      lastDeliveryError: "",
    },
  ],
  calendarSyncSettings: [
    {
      ...
      organizationId: fallbackOrganization.id,
      integrationConnectionId: "integration-google-demo",
      eventType: "SubmissionDeadline",
      calendarReference: "primary",
      calendarLabel: "MSR Submission Calendar",
      defaultReminderOffsets: [7, 3, 1],
      isEnabled: true,
      syncAllTeams: true,
      teamId: null,
      lastSyncedAtUtc: new Date("2026-04-01T14:55:00Z").toISOString(),
      lastSyncError: "",
    },
  ],
  profileSyncSettings: [
    {
      id: "profile-sync-demo",
      organizationId: fallbackOrganization.id,
      integrationConnectionId: "integration-google-demo",
      isEnabled: true,
      syncJobTitles: true,
      ...
      lastSyncedAtUtc: new Date("2026-04-01T15:05:00Z").toISOString(),
      lastSyncError: "",
    },
  ],
  profileSyncJobs: [
    {
      id: "profile-sync-job-demo",
      organizationId: fallbackOrganization.id,
      profileSyncSettingId: "profile-sync-demo",
      integrationConnectionId: "integration-google-demo",
      status: "Succeeded",
      triggeredBy: "OrgAdmin",
      summary: "Google Workspace profile sync completed.",
      usersProcessed: 18,
      usersMatched: 16,
      usersUpdated: 11,
      errorDetails: "",
      startedAtUtc: new Date("2026-04-01T15:02:00Z").toISOString(),
      completedAtUtc: new Date("2026-04-01T15:05:00Z").toISOString(),
    },
  ],
...
export async function getDashboardData() {
  ...
  return {
    ...
    integrationSignals: {
      connectedProviders: enterprise.integrations.length,
      lastProfileSyncAt: enterprise.profileSyncJobs[0]?.completedAtUtc ?? enterprise.profileSyncSettings[0]?.lastSyncedAtUtc ?? null,
      notificationRoutes: enterprise.notificationRoutes.length,
      exportDestinations: enterprise.exportDestinations.length,
      calendarSyncs: enterprise.calendarSyncSettings.length,
    },
  };
}
...
async function getEnterpriseSettingsData(organizationId: string) {
  try {
    ...
    return {
      ...fallbackEnterpriseSettings,
      authentication: {
        ...fallbackEnterpriseSettings.authentication,
        organizationId,
      },
      identityProviders: fallbackEnterpriseSettings.identityProviders.map((provider) => ({ ...provider, organizationId })),
      integrations: fallbackEnterpriseSettings.integrations.map((integration) => ({ ...integration, organizationId })),
      verifiedDomains: fallbackEnterpriseSettings.verifiedDomains.map((domain) => ({ ...domain, organizationId })),
      provisioning: {
        ...fallbackEnterpriseSettings.provisioning,
        organizationId,
      },
      provisioningJobs: fallbackEnterpriseSettings.provisioningJobs.map((job) => ({ ...job, organizationId })),
      directoryGroupMappings: fallbackEnterpriseSettings.directoryGroupMappings.map((mapping) => ({ ...mapping, organizationId })),
      notificationRoutes: fallbackEnterpriseSettings.notificationRoutes.map((route) => ({ ...route, organizationId })),
      exportDestinations: fallbackEnterpriseSettings.exportDestinations.map((destination) => ({ ...destination, organizationId })),
      calendarSyncSettings: fallbackEnterpriseSettings.calendarSyncSettings.map((setting) => ({ ...setting, organizationId })),
      profileSyncSettings: fallbackEnterpriseSettings.profileSyncSettings.map((setting) => ({ ...setting, organizationId })),
      profileSyncJobs: fallbackEnterpriseSettings.profileSyncJobs.map((job) => ({ ...job, organizationId })),
    } satisfies OrganizationEnterpriseSettingsDto;
  }
}
